<?php defined('BASEPATH') or exit('No direct script access allowed');
    ...
    class order_data_model extends Base_Model {
	    ...
	    {
		    $total = $this->db->select()->from('order_data')->where($syntax)->get()->num_rows();
        ...
        public function edit($home_id, $data){
            return $this->db->where(array("id"=>$home_id))->update('order_data', $data);
        }
        ...
        public function add($data){
           ...
           // var_dump($data['type']);
            ...
            $res = $this->db->insert('order_data', $data);
        ...
        public function get_data($home_id){
            return $this->db->get_where('order_data', array("id"=>$home_id))->row_array();
        }


        public function get_all_post(){
            $str="select * from order_data where is_delete=0 ";
