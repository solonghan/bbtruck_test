<?php defined('BASEPATH') or exit('No direct script access allowed');
    ...
    class Bill_model extends Base_Model {
	    ...
	    {
		    $total = $this->db->select()->from('bill')->where($syntax)->get()->num_rows();
        ...
        public function edit($home_id, $data){
            return $this->db->where(array("id"=>$home_id))->update('bill', $data);
        }
        ...
        public function get_data($home_id){
            return $this->db->get_where('bill', array("id"=>$home_id))->row_array();
        }


        public function get_all_post(){
            $str="select * from bill where is_delete=0 ";
